...
type TableName = 'products' | 'locations' | 'stock_levels' | 'stock_movements' | 'profiles' | 'user_roles' | 'purchase_orders' | 'purchase_order_items' | 'table_plans' | 'user_departments' | 'rooms' | 'guests' | 'reservations' | 'room_charges' | 'housekeeping_tasks' | 'housekeeping_logs' | 'maintenance_requests';
